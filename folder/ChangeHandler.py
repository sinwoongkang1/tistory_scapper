...
class ChangeHandler(FileSystemEventHandler):
    def __init__(self):
        ...
        self.ignore_events = False   # 이벤트 무시 플래그
    ...
    def handle_event(self, event):
        if event.is_directory or self.is_committing or self.ignore_events:
            return
        ...
        self.ignore_events = True  # 이벤트 무시 플래그 설정
        ...
        try:
            ...
            self.ignore_events = False  # 이벤트 무시 플래그 해제
